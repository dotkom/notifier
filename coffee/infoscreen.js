...
(function() {
  var $, insertBusInfo, iteration, listDinners, ls, mainLoop, updateBus, updateCantinas, updateNews, updateOffice, updateTodays;
  ...
  mainLoop = function() {
    ...
    if (iteration % UPDATE_TODAYS_INTERVAL === 0) {
      updateTodays();
    }
  ...
  updateTodays = function() {
    if (DEBUG) {
      console.log('updateTodays');
    }
    return Office.getTodaysEvents(function(events) {
      return $('#todays #office_events').html(events);
    });
  };
