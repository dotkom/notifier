...
(function() {
  var $, chatterText, clickDinnerLink, createBusDataRequest, displayItems, fadeButtonText, findUpdatedPosts, insertBusInfo, iteration, listDinners, ls, mainLoop, newsLimit, optionsText, tipsText, updateAffiliationNews2, updateBus, updateCantinas, updateCoffee, updateHours, updateMeetings, updateNews, updateServant,
  ...
  updateNews = function() {
    ...
    if (feedItems !== void 0) {
      ...
      return displayItems(feedItems, '#left', 'affiliationNewsList', 'affiliationViewedList', 'affiliationUnreadCount');
    } else {
      key = ls.affiliationKey;
      name = Affiliation.org[key].name;
      return $('#news #left').html('<div class="post"><div class="title">Nyheter</div><div class="item">Frakoblet fra ' + name + '</div></div>');
    }
  };
  ...
  updateAffiliationNews2 = function() {
    ...
    if (feedItems !== void 0) {
      feedItems = JSON.parse(feedItems);
      return displayItems(feedItems, '#right', 'affiliationNewsList2', 'affiliationViewedList2', 'affiliationUnreadCount2');
    } else {
      key = ls.affiliationKey2;
      name = Affiliation.org[key].name;
      return $('#news #right').html('<div class="post"><div class="title">Nyheter</div><div class="item">Frakoblet fra ' + name + '</div></div>');
    }
  };
