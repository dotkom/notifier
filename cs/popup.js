...
(function() {
  var $, animateOracleAnswer, animateOracleQuestion, bindOracle, bindPrediction, changeOracleAnswer, changeOracleQuestion, chatterText, clickDinnerLink, clickHours, createBusDataRequest, displayItems, fadeButtonText, findUpdatedPosts, insertBusInfo, iteration, listDinners, ls, mainLoop, newsLimit, optionsText, oraclePrediction, tipsText, updateAffiliationNews, updateBus, updateCantinas, updateCoffee, updateHours, updateMeetings, updateServant,
  ...
  bindOracle = function() {
    return $('#oracle #question').keyup(function(e) {
      var question;
      question = $('#oracle #question').val();
      if (e.which === 13) {
        if (question !== '') {
          return Oracle.get(question, function(answer) {
            return changeOracleAnswer(answer);
          });
        } else {
          return changeOracleAnswer(Oracle.greet());
        }
      } else {
        if (question === '') {
          return changeOracleAnswer('');
        }
      }
    });
  };
  ...
  bindPrediction = function() {
    ...
    return setTimeout((function() {
      return $('#oracle #question').attr('placeholder', Oracle.msgCantPredictShort);
    }), 10000);
  };
  ...
  oraclePrediction = function() {
    ...
    if (question !== null) {
      ...
      return setTimeout((function() {
        return changeOracleAnswer(Oracle.msgCantPredictLong);
      }), 200);
    }
  };
