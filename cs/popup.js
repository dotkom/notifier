...
(function() {
  var $, chatterText, clickDinnerLink, createBusDataRequest, displayItems, fadeButtonText, findUpdatedPosts, insertBusInfo, iteration, listDinners, ls, mainLoop, newsLimit, optionsText, tipsText, updateBus, updateCantinas, updateCoffee, updateHours, updateMedia, updateMeetings, updateNews, updateServant,
  ...
  updateMedia = function() {
    ...
    if (feedItems !== void 0) {
      feedItems = JSON.parse(feedItems);
      return displayItems(feedItems, '#right', 'mediaNewsList', 'mediaViewedList', 'mediaUnreadCount');
    } else {
      key = ls.mediaKey;
      name = Affiliation.org[key].name;
