...
(function() {
  var $, animateCreatorName, bindAffiliationSelector, bindBusFields, bindCantinaSelector, bindFavoriteBusLines, bindPaletteSelector, bindSuggestions, changeCreatorName, changeOfficeStatusIcons, disableHardwareFeatures, enableHardwareFeatures, getDirections, getFavoriteLines, loadBus, ls, pageFlipCursorBlinking, popupHere, resizeBackgroundImage, restoreChecksToBoxes, revertBigscreen, saveBus, showSavedNotification, slideFavoriteBusLines, slideFlashyNews, switchBigScreen, testCoffeeSubscription, testDesktopNotification, toggleBigscreen,
  ...
  slideFlashyNews = function() {
    setTimeout((function() {
      if (!$('#affiliationBox').hasClass('hover')) {
        ...
        return $('#affiliationBox #arrowDown').fadeIn();
      }
    }), 1500);
    $('#affiliationBox').mouseenter(function() {
      clearTimeout($(this).data('timeoutId'));
      $('#affiliationBox #flashyNews').slideDown();
      return $('#affiliationBox #arrowDown').fadeOut();
    });
    return $('#affiliationBox').mouseleave(function() {
      var timeoutId;
      timeoutId = setTimeout((function() {
        $('#affiliationBox #flashyNews').slideUp();
        return $('#affiliationBox #arrowDown').fadeIn();
      }), 500);
      return $('#affiliationBox').data('timeoutId', timeoutId);
    });
  };
  ...
  switchBigScreen = function(type) {
    ...
    url = type + '.html';
    return $('#bigscreenPreview').attr('src', url);
  };
  ...
  $(function() {
    ...
    if (ls.useBigscreen === 'true') {
      setTimeout((function() {
        ...
        return toggleBigscreen(true, type, true);
      }), 300);
    }
    ...
    $('#modalNotifier').click(function() {
      ...
      if (localStorage.whichScreen !== 'notifier') {
        ...
        return localStorage.whichScreen = 'notifier';
      }
    });
    $('#modalInfoscreen').click(function() {
      ...
      if (localStorage.whichScreen !== 'infoscreen') {
        ...
        return localStorage.whichScreen = 'infoscreen';
      }
    });
    $('#modalOfficescreen').click(function() {
      ...
      if (localStorage.whichScreen !== 'officescreen') {
        ...
        ls.useBigscreen = 'true';
        return localStorage.whichScreen = 'officescreen';
      }
    });
